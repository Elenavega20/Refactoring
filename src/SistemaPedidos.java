// //utilizar programación orientado a objetos, renombrear variables con nombres que faciliten la compresión. Y ordena el código con esta estructura: 
// //cliente: atributos, constructores, métodos públicos y métodos privados. 
// //producto: precio, nombre
// //pedido: cliente, productos --> arrayList (con los productos), agragar productos, calcular subtotal(), AplicarDescuentos(), SubtotalDescuentos() , CalcularTotalConIva().
